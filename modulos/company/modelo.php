<?php
	...
	{   
    	...
    	{    		
			...
			$option["select"]["admin_soles37.FN_ImgFile('../modulos/users/img/user.png',files_id,180,100)"]	="img_files_id_med";				
			$option["select"]["admin_soles37.FN_ImgFile('../modulos/users/img/user.png',files_id,180,100)"]	="img_files_id_chi";
