<?php
	...
	$objeto->words["html_head_title"]          ="Soles GPS :: Configuracion de dispositivos GPS";
	$objeto->words["html_head_description"] =   "Manuales y configuraciones de dispositivos GPS para la plataforma SolesGPS";
