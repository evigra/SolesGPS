<?php
	...
	if($objeto->sys_section=="stop")
	{
		$objeto->words["system_module"]             =$objeto->__TEMPLATE($objeto->sys_module . "html/report");
		
		$files_js[]="../{$objeto->sys_module}js/history";
    
    	$objeto->words["module_view"]				= $objeto->__TEMPLATE($objeto->sys_module . "html/map");			
		$option["template_title"]	                = $objeto->sys_module . "html/report_title";
		$option["template_body"]	                = $objeto->sys_module . "html/report_body";
		
		$data										=$objeto->time_position($option);
		$objeto->words["module_report"]				=$data["html"];
    }
