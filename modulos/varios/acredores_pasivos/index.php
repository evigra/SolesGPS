<?php
	require_once("modulos/contabilidad/modelo.php");
	require_once("modelo.php");

	$objeto							=	new acredores_pasivo();
	$objeto->__SESSION();
	...
	elseif($objeto->sys_section=="kanban")
	{
		...
		$template_body					=	"modulos/contabilidad/html/kanban_detalle";	
	   	$data							=	$objeto->reporte_kanban();        	
    	$objeto->words["module_body"]	=	$objeto->__VIEW_KANBAN($template_body,$data);	
    }	
	else
	{
	    $module_left	=	"";
