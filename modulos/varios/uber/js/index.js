    	...
    	if($("div#map").length>0) 
    	{
			...
			$("#accion_punto")
				...
				.click(function()
				{
					...
					GeoMarker[0]=coordinate;										
					GeoMarker1[0]=location;
				}
			);	
			$("#finalizar_punto")
				.button({
				...
				.click(function()
				{
					GeoMarker[1]=coordinate;										
					GeoMarker1[1]=location;
					
					if(GeoMarker1.length>1)
					{
						var tot			=GeoMarker1.length;
						if(tot==2)
						{
							var origen		=GeoMarker1[0];
							var origen1		=String(origen);						

							var destino		=GeoMarker1[1];
