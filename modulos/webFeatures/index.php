<?php
	...
	$objeto->words["html_head_title"]          ="Soles GPS :: Caracteristicas";
	$objeto->words["html_head_description"] =   "SOLES GPS, PAGINA DE CARACTERISTICAS PRINCIPALES. EMPRESA DEDICADA AL RASTREO SATELITAL VEHICULAR Y CELULAR.";
